...
| **Impact** | Shape of Dev/Coverage-authored hunt profiles. Does not change existing profiles until regenerated. |
| **Tasks** | Ralph `generate_skill` (e.g. Coverage generate). |
